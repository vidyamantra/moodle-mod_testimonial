...
require_once($CFG->dirroot . '/mod/feedcam/backup/moodle2/restore_feedcam_stepslib.php'); // Because it exists (must)

/**
 * feedcam restore task that provides all the settings and steps to perform one
 * complete restore of the activity
 */
class restore_feedcam_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_feedcam_activity_structure_step('feedcam_structure', 'feedcam.xml'));
    }
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('feedcam', array('intro'), 'feedcam');
    ...
    static public function define_restore_log_rules_for_course() {
        ...
        $rules[] = new restore_log_rule('feedcam', 'view all', 'index?id={course}', null,
                                        null, null, 'index.php?id={course}');
        $rules[] = new restore_log_rule('feedcam', 'view all', 'index.php?id={course}', null);
